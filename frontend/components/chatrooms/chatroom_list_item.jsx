...
class ChatroomListItem extends React.Component{
  ...
  handleMouseEnter(e){
    ...
    document.getElementById('tooltips').innerHTML=`<div class="info-bubble chatroom-tooltip-${this.props.chatroom.id}" style="display: block; position: fixed; top: ${domRect.y + 20}px; left: ${domRect.width + 3}px;">${this.props.chatroom.title}</div>`;
  }
